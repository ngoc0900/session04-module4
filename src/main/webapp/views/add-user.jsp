...
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <h1>Thêm mới user</h1>
      <f:form method="post" action="/save-user" modelAttribute="user">
        ...
        <div class="form-group">
          ...
          <div class="form-check form-check-inline">
            <label class="form-check-label">
              <f:radiobutton class="form-check-input" value="1" path="sex"/>Nữ
            </label>
          </div>
          <div class="form-check form-check-inline">
            <label class="form-check-label">
              <f:radiobutton class="form-check-input" value="0" path="sex"/>Nam
            </label>
          </div>
        </div>
